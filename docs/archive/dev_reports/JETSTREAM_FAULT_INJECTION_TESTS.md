...
|----|-------------|--------|--------|----------------------------------|
| R1 | Intermittent ACK/NAK errors are handled in a fail-open way, Router does not crash, delivery count is tracked | Scenario 1, this doc | Done | `router_jetstream_e2e_SUITE:test_intermittent_ack_failure_recovery/1` · `router_delivery_count_tracking_SUITE:test_delivery_count_tracking_under_ack_failures/1` · `docs/archive/dev/E2E_FAULT_INJECTION_COVERAGE_PLAN.md#implemented-tests` |
...
- **Coverage Plan**: `docs/archive/dev/E2E_FAULT_INJECTION_COVERAGE_PLAN.md` - Detailed coverage plan and implementation status
...
- **Extended Recovery Requirements**: `docs/archive/dev/EXTENDED_RECOVERY_REQUIREMENTS.md` - Formal requirements specification
- **Extended Recovery Gap Analysis**: `docs/archive/dev/EXTENDED_RECOVERY_GAP_ANALYSIS.md` - Gap analysis comparing Extended Recovery with existing tests
- **Extended Recovery Executive Summary**: `docs/archive/dev/EXTENDED_RECOVERY_EXECUTIVE_SUMMARY.md` - Executive summary for technical leads
...
- `docs/archive/dev/JETSTREAM_FAULT_INJECTION_TESTS.md#scenario-2-processing-delays-causing-redelivery-growth` - Redelivery growth scenario
...
**Related Documentation**:
- `docs/archive/dev/JETSTREAM_FAULT_INJECTION_TESTS.md#scenario-3-maxdeliver-exhaustion-for-partial-messages` - MaxDeliver exhaustion scenario
...
**Related Documentation**:
- `docs/archive/dev/JETSTREAM_FAULT_INJECTION_TESTS.md#scenario-2-processing-delays-causing-redelivery-growth` - Queue growth scenario
