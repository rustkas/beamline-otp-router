...
**Documentation**:
- Spec: `docs/dev/JETSTREAM_FAULT_INJECTION_TESTS.md`
- Coverage Plan: `docs/dev/E2E_FAULT_INJECTION_COVERAGE_PLAN.md`
- Implementation Report: `docs/dev/E2E_FAULT_INJECTION_IMPLEMENTATION_REPORT.md`
- Final Status: `docs/dev/E2E_FAULT_INJECTION_FINAL_STATUS.md`
