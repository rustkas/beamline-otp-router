...
init_per_suite(Config) ->
    ...
    MetricsTable = router_ets_helpers:ensure_named_ets_table(ext_metrics, [set, public]),
...
test_no_errors(_Config) ->
    ...
    ?assert(Stats#stats.p95_ms < 150),  % Allow headroom for 10ms mock sleep + pipeline overhead
    ok.
...
test_throughput_measurement(_Config) ->
    ...
    {Latencies, SuccessCount, ErrorCount} = execute_timed_load_test(DurationMs, Policy),
    ...
    record_observation(<<"baseline">>, false, Stats, Throughput, ErrorRate),
