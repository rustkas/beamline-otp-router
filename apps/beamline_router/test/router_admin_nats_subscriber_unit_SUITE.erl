%% @doc Unit Tests for router_admin_nats_subscriber module
%% @test_category unit, fast, coverage_hotspot
-module(router_admin_nats_subscriber_unit_SUITE).
...
test_module_exported(_Config) ->
    ...
    Info = router_admin_nats_subscriber:module_info(exports),
...
test_module_attributes(_Config) ->
    ...
    Attrs = router_admin_nats_subscriber:module_info(attributes),
