...
init_per_suite(Config) ->
    ...
    _ = router_ets_helpers:ensure_named_ets_table(published_events, [set, public]),
    Config.
...
init_per_testcase(_TestCase, Config) ->
    ...
    _ = router_ets_helpers:ensure_named_ets_table(published_events, [named_table, set, public]),
...
test_execresult_metadata_preservation(_Config) ->
    ...
    PublishedEvents = router_ets_helpers:ensure_named_ets_table(published_events, [set, public]),
