%% # Unit Tests for router_audit
%%
%% unit, fast, coverage_hotspot
...
%% Common Test exports
-export([all/0, groups_for_level/1, groups/0, init_per_suite/1, end_per_suite/1, init_per_testcase/2,
         end_per_testcase/2]).
%% Test function exports
-export([test_log_policy_action/1, test_log_rbac_action/1, test_log_config_action/1,
         test_log_decision/1, test_get_audit_entries/1, test_get_client_ip/1,
         test_get_audit_retention_days/1, test_clear_all_audit_entries/1, test_get_table_size/1,
         test_get_table_memory/1, test_check_size_limit/1, test_cleanup/1]).
