...
test_basic_tracking(_Config) ->
    ...
    case router_ets_helpers:ets_lookup(Table, MsgId) of
        [{MsgId, 1}] -> ok;
...
test_maxdeliver_exhaustion_removes_tracking(_Config) ->
    ...
    [] = router_ets_helpers:ets_lookup(router_delivery_count, MsgId),
    ok.
...
test_maxdeliver_not_exhausted(_Config) ->
    ...
    [{MsgId, 2}] = router_ets_helpers:ets_lookup(router_delivery_count, MsgId),
    ok.
