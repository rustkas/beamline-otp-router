...
init([]) ->
    ...
    BaseChildren = [
        ...
        %% Log writer (async logging)
        {router_log_writer,
         {router_log_writer, start_link, []},
         permanent, 5000, worker, [router_log_writer]},
        ...
        %% Alerts (manages alert evaluation and reporting)
        {router_alerts,
         {router_alerts, start_link, []},
         permanent, 5000, worker, [router_alerts]}
