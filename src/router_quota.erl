...
-compile({nowarn_unused_function, [
    ...
    enforce_size_limit_if_needed/0,
    evict_oldest_quotas/1
]}).
...
%% @doc Check if tenant can create more policies
...
%% @doc Check if policy can have more rules
...
%% @doc Check if policy can have more providers
...
%% @doc Get tenant quota configuration
...
%% @doc Set tenant quota configuration
...
%% @doc Get quota usage for tenant
...
%% @doc Clear all quota entries (for testing)
%% @returns ok
