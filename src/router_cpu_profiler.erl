...
%% @doc Get overall CPU usage percentage
...
%% @doc Get CPU usage for a specific process
%% Returns: {ok, CpuUsagePercent} | {error, Reason}
...
%% @doc Calculate process CPU usage from reductions and message queue
...
%% @doc Start profiling for a module or function
...
%% @doc Track hot path (function call with high CPU usage)
%% Module: Module name
...
%% @doc Get hot paths (functions with highest CPU usage)
...
%% @doc Store profiling state in ETS
...
%% @doc Generate trace filename for profiling type
