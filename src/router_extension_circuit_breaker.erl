...
%% @doc Check if circuit is open (should fail fast)
...
%% @doc Record successful extension invocation
%% Returns: ok
...
%% @doc Record failed extension invocation
%% Returns: ok
...
%% @doc Update circuit breaker state
...
%% @doc Check if recovery should be attempted
%% Returns: true | false
...
%% @doc Get circuit breaker states for all extensions
