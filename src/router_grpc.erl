...
-compile({nowarn_unused_function, [
    extract_correlation_id/1,              % Used: line 63
    extract_user_id_from_context/1,        % Used: internal helper (may be called dynamically)
    extract_user_id_from_request/1,        % Used: line 111
    extract_correlation_fields_from_request/1,  % Used: line 107
    extract_tenant_id_from_request/1,       % Used: line 64
    decode_route_request/1,                 % Used: line 98
    decode_route_request_internal/1,        % Used: called by decode_route_request/1
    convert_route_request/1,                % Used: called by decode_route_request_internal/1
    convert_message/1,                     % Used: called by convert_route_request/1
    convert_context/1,                      % Used: called by convert_route_request/1
    convert_metadata/1,                     % Used: called by convert_message/1
    encode_route_decision/1,                % Used: lines 186, 206
    convert_map_to_proto_metadata/1,       % Used: called by encode_route_decision/1
    check_rate_limit_for_request/3,         % Used: line 103
    check_rate_limit_with_correlation/3    % Used: called by check_rate_limit_for_request/3
]}).
...
%% @doc Router.Decide RPC implementation
%% 
...
%% @doc Extract user_id from gRPC context
...
%% @doc Extract user_id from RouteRequest (for rate limiting)
...
%% @doc Extract CP1 correlation fields (run_id, flow_id, step_id) from RouteRequest
...
%% @doc Extract tenant_id from RouteRequest (for metrics)
