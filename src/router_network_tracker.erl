...
%% @doc Complete round trip tracking
...
%% @doc Get round trip time for an operation
...
%% @doc Batch operations (helper for batching network calls)
...
%% @doc Coalesce requests (helper for request coalescing)
