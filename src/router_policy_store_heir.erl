...
%% @doc Start heir process
start_link() ->
    gen_server:start_link({local, ?MODULE}, ?MODULE, [], []).

%% @doc Request transfer of tables to new owner
...
%% @doc Initialize heir process
init([]) ->
    {ok, #state{}}.

%% @doc Handle claim request
...
%% @doc Receive ETS table transfer when owner process crashes
