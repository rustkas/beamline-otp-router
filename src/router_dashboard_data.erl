...
%% @doc Get R10 dashboard data (all tenants/providers)
-spec get_r10_dashboard_data() -> map().
get_r10_dashboard_data() ->
    get_r10_dashboard_data(#{}).

%% @doc Get R10 dashboard data with filters
...
%% @doc Get performance dashboard data (all tenants)
-spec get_performance_dashboard_data() -> map().
get_performance_dashboard_data() ->
    get_performance_dashboard_data(#{}).

%% @doc Get performance dashboard data with filters
...
%% @doc Get trigger reason dashboard data (all tenants/providers)
-spec get_trigger_reason_dashboard_data() -> map().
get_trigger_reason_dashboard_data() ->
    get_trigger_reason_dashboard_data(#{}).

%% @doc Get trigger reason dashboard data with filters
...
%% @doc Aggregate trigger reasons (for pie/bar charts)
-spec aggregate_trigger_reasons() -> map().
aggregate_trigger_reasons() ->
    aggregate_trigger_reasons(#{}).

%% @doc Aggregate trigger reasons with filters
