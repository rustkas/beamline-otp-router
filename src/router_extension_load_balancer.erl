...
%% @doc Select instance for extension (weighted round-robin with health awareness)
...
%% @doc Get all instances for extension
...
%% @doc Update instance health status
...
-compile({nowarn_unused_function, [build_instance_health_updates/2]}).
