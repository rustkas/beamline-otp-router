...
%% @doc Map extension error to Gateway-compatible format
...
%% @doc Map extension error reason to Gateway error code
...
%% @doc Map extension error reason to human-readable message
