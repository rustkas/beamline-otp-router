...
%% @doc Get size (number of entries) of an ETS table
...
%% @doc Get memory usage (bytes) of an ETS table
...
%% @doc Get sizes of all known ETS tables
...
%% @doc Get memory usage of all known ETS tables
...
%% @doc Check if table size exceeds limit
...
%% @doc Enforce table size limit by evicting oldest entries
...
%% @doc Get comprehensive resource statistics
