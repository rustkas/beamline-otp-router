...
%% @doc Start a new span with parent context
...
%% @doc Extract trace context from message/headers
...
%% @doc Inject trace context into message/headers
...
%% @doc Execute function within a span (convenience wrapper)
%% Removed with_span/3 spec to avoid unused export warnings; use with_span/4

%% @doc Execute function within a span with parent context
...
-compile({nowarn_unused_function, [format_error/1]}).
...
%% @doc Get sampling configuration
...
%% @doc Set sampling configuration
