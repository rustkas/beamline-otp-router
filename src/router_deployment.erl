...
-export([
    ...
    rollback/1,
    get_deployment_status/0,
    get_deployment_history/0,
    check_pre_deployment/0,
    check_post_deployment/0
]).
                    ...
                    {ok, ValidationResults} ->
                        ...
                        case check_post_deployment() of
                            {ok, PostCheckResults} ->
                                ...
                                UpdatedState = DeploymentState#deployment_state{
                                    status = deployed,
                                    validation_passed = true
                                },
    ...
    try
        ...
        case validate_version_format(Version) of
            true ->
                ...
                AllChecksPassed = maps:get(passed, HealthCheck, false) andalso
                                 maps:get(passed, ConfigCheck, false) andalso
                                 maps:get(passed, DepsCheck, false) andalso
                                 maps:get(passed, ResourcesCheck, false),
    ...
    try
        ...
        case check_rollback_available(Version) of
            true ->
                ...
                %% Update deployment state
                RollbackState = #deployment_state{
                    version = Version,
                    timestamp = erlang:system_time(millisecond),
                    status = rolled_back,
                    validation_passed = true,
...
check_pre_deployment() ->
    try
        ...
        AppRunning = case application:which_applications() of
        ...
        SupRunning = case whereis(beamline_router_sup) of
            Pid when is_pid(Pid) ->
                true;
            _ ->
                false
        ...
        AllChecksPassed = AppRunning andalso SupRunning andalso
                         maps:get(passed, NatsCheck, false) andalso
                         maps:get(passed, DiskCheck, false),
...
check_post_deployment() ->
    try
        ...
        AllChecksPassed = maps:get(passed, HealthCheck, false) andalso
                         maps:get(passed, GrpcCheck, false) andalso
                         maps:get(passed, MetricsCheck, false),
...
check_resources() ->
    try
        ...
        #{
            passed => maps:get(passed, MemoryCheck, false) andalso
                     maps:get(passed, DiskCheck, false),
            memory => MemoryCheck,
            disk => DiskCheck
        }
...
check_memory() ->
    try
        %% Check if we have at least 128MB available
        MemoryInfo = erlang:memory(),
        TotalMemory = maps:get(total, MemoryInfo, 0),
    ...
    try
        ...
        case GrpcEnabled of
            true ->
                ...
                GrpcRunning = case whereis(router_grpc_sup) of
                    Pid when is_pid(Pid) ->
                        true;
                    _ ->
                        false
    ...
    try
        ...
        case MetricsEnabled of
            true ->
                ...
                MetricsAvailable = case erlang:function_exported(router_metrics_http, get_port, 0) of
                    true ->
                        try
                            _Port = router_metrics_http:get_port(),
                            true
                        catch
                            _:_ -> false
                        end;
