        ...
        false ->
            ...
            case application:ensure_all_started(beamline_router) of
                {ok, _} ->
                    ...
                    ok;
                {error, Reason} ->
                    error_logger:error_msg("beamline_router start failed: ~p~n", [Reason]),
...
%% - get_publish_attempts/0 -> router_r10_metrics:get_publish_attempts_total/0
%% - get_publish_errors/0 -> router_r10_metrics:get_publish_errors_total/0
%% - get_publish_attempts_delta/1 -> router_r10_metrics:get_publish_attempts_delta/1
%% - get_publish_errors_delta/1 -> router_r10_metrics:get_publish_errors_delta/1
%% - assert_max_attempts_not_exceeded/1 -> Removed (not implemented, use router_r10_metrics)
%% - assert_retry_model_behavior/4 -> Removed (not implemented, use router_r10_metrics)
