...
test_publish_and_ack_failures(_Config) ->
    ...
    ProcessedCount = router_test_init:ensure_ets_table(processed_count, [set, public]),
...
test_connect_and_publish_failures(_Config) ->
    ...
    Subject = <<"caf.exec.result.v1">>,
    ErrorCount = router_test_init:ensure_ets_table(error_count, [set, public]),
...
test_faults_with_backpressure(_Config) ->
    ...
    PendingTable = router_test_init:ensure_ets_table(pending_requests, [set, public, named_table]),
